...
#--------------------------------------------------
# Add LibreOffice 3.6.7.2 From Archives
#--------------------------------------------------
sudo apt-get --purge remove libreoffice openoffice -y
cd /tmp
sudo wget http://downloadarchive.documentfoundation.org/libreoffice/old/3.6.7.2/deb/x86_64/LibO_3.6.7.2_Linux_x86-64_install-deb_en-US.tar.gz
sudo tar -xvzf LibO_3.6.7.2_Linux_x86-64_install-deb_en-US.tar.gz
cd /tmp/LibO_3.6.7.2_Linux_x86-64_install-deb_en-US/DEBS
sudo dpkg -i *.deb -y
